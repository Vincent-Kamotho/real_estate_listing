                    ...
                    <div class="col-lg-12">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                <div class="card-body">
                                    <form action="{{url('update_client/' . $clients->id )}}" method="POST">
                                        @csrf
                                        @if (session('success'))
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="firstName" id="firstName" value={{$clients->first_name}} required="required">
                                            </div>
                                            <div class=" col-md-6">
                                                <label class="form-label" for="lastName">Last Name</label>
                                                <input type="text" class="form-control" name="lastName" id="lastName" value={{$clients->last_name}} required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="email" class="form-control" name="email" id="email" value={{$clients->email}} required="required">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label" for="contact">Contacts</label>
                                                <input type="text" class="form-control" name="phone_contact" id="phone_contact" value={{$clients->contacts}} required="required">
                                            </div>
                                        </div>
