                        ...
                        <div class="row">
                            <div class="col-xl-9 col-lg-10 col-md-10 ">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInUp" data-delay="0.1s">Find Your property of Choice</h1>
                                    <p data-animation="fadeInUp" data-delay="0.6s">We Have Over Million Properties For
                                        You</p>
                                    ...
                                    <div class="properties__button">
                                        ...
                                        <nav>
                                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                <a class="nav-item nav-link active" id="nav-one-item-tab"
                                                    data-toggle="tab" href="#nav-one-item" role="tab"
                                                    aria-controls="nav-one-item" aria-selected="true">Buy Property</a>
                                            </div>
                                        </nav>
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="nav-one-item" role="tabpanel"
                                        aria-labelledby="nav-one-item-tab">

                                        <form action="{{route('search-property')}}" class="search-box">
                                            
                                            {{--<div class="select-form">
                                                <div class="select-itms">
                                                    <select name="property_type" id="select1">
                                            ...
                                            <div class="select-form">
                                                <div class="select-itms">
                                                    <select name="property_subtype" id="select1">
                                                        <option value="">Property Type</option>
                                                        ...
                                                        <option value="Villans">Villans</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="single-cat mb-30">
                                ...
                                <div class="cat-cap">
                                    <h5><a href="{{url('view-property/'.$property->id)}}">{{$property->description}}</a></h5>
                            ...
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-tittle">
                                    <div class="footer-pera">
                                        <p>Productboard is the product management system that helps </p>
                                    </div>
                                </div>
...
<!-- Mirrored from preview.colorlib.com/theme/rolast/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 10:49:52 GMT -->
