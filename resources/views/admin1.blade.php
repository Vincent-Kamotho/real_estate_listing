...
<!-- Mirrored from demo.dashboardpack.com/sales-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 May 2023 15:20:29 GMT -->
...
<head>
    ...
    <link rel="stylesheet" href="{{asset('myassets/vendors/vectormap-home/vectormap-2.0.2.css')}}" />
...
<body class="crm_body_bg">
                    ...
                    <div class="header_iner d-flex justify-content-between align-items-center">
                        ...
                        <div class="serach_field-area d-flex align-items-center">
                            <div class="search_inner">
                                <form action="#">
                                    ...
                                    <button type="submit"> <img src="{{asset('myassets/img/icon/icon_search.svg')}}" alt> </button>
                                </form>
                            </div>
                        ...
                        <div class="header_right d-flex justify-content-between align-items-center">
                            ...
                            <div class="profile_info">
                                <img src="{{asset('myassets/img/client_img.png')}}" alt="#">
    ...
    <script src="{{asset('myassets/vendors/datepicker/datepicker.js')}}"></script>
    <script src="{{asset('myassets/vendors/datepicker/datepicker.en.js')}}"></script>
    <script src="{{asset('myassets/vendors/datepicker/datepicker.custom.js')}}"></script>
    <script src="{{asset('myassets/js/chart.min.js')}}"></script>
    <script src="{{asset('myassets/vendors/chartjs/roundedBar.min.js')}}"></script>
    ...
    <script src="{{asset('myassets/vendors/vectormap-home/vectormap-2.0.2.min.js')}}"></script>
    <script src="{{asset('myassets/vendors/vectormap-home/vectormap-world-mill-en.js')}}"></script>

    <script src="{{asset('myassets/vendors/apex_chart/apex-chart2.js')}}"></script>
    <script src="{{asset('myassets/vendors/apex_chart/apex_dashboard.js')}}"></script>
    <script src="{{asset('myassets/vendors/echart/echarts.min.js')}}"></script>
    ...
    <script src="{{asset('myassets/js/dashboard_init.js')}}"></script>
    <script src="{{asset('myassets/js/custom.js')}}"></script>
</body>

<!-- Mirrored from demo.dashboardpack.com/sales-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 May 2023 15:21:17 GMT -->
