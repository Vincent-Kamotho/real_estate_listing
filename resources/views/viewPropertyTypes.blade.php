                                    ...
                                    <div class="QA_section">
                                        <div class="white_box_tittle list_header">
                                            ...
                                            <div class="box_right d-flex lms_block">
                                                ...
                                                <div class="add_button ms-2">
                                                    <a href="{{route('property_types1')}}" class="btn btn-success">Add Propety Type</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="QA_table mb_30">
                                            ...
                                            <table class="table lms_table_active ">
                                                ...
                                                @foreach ($propertyTypes as $propertType)
                                                <tbody>
                                                    <tr>
                                                        <td>{{$propertType ->property_name }}</td>
                                                        <td>
                                                            <a href="{{url('edit_property_type/'.$propertType->id)}}" class="btn btn-success">Edit</a>
                                                            <a href="{{url('delete_property_type/'.$propertType->id)}}" class="btn btn-danger">Delete</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                @endforeach
