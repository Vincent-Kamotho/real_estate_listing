                    ...
                    <div class="col-lg-12">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                <div class="card-body">
                                    <form action={{route('add_property_subtype_hierarchy')}} method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @if (session('success'))
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <select name="property_type" id="property_type" class="form-select" required>
                                                    ...
                                                    <option value="{{ $propertyType->property_name }}">{{
                                                        $propertyType->property_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name = "propertysubType" id="propertysubType" placeholder="Property Subtype">
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class=" col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="propertyPrice" id="PropertyPrice" placeholder="KES">
                                            </div>
                                        </div>

                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <label class="form-label" for="propertyOwner">Property Owner</label>
                                                <input type="text" class="form-control" name="propertyOwner" id="propertyOwner" placeholder="Property Owner">
                                            </div>
