                            ...
                            <div class="white_card_body">
                                <div class="card-body">
                                    <form action={{route('add_property_type')}} method="POST">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <label class="form-label" for="inputPropertyType">Name</label>
                                                <input type="text" class="form-control" id="inputPropertyType" name = "property_name" placeholder="Enter Property Name">
                                            </div>
