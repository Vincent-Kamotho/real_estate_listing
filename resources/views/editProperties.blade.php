...
<head>
    ...
    <title>Edit Property Types</title>
                    ...
                    <div class="col-lg-12">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                <div class="card-body">
                                    <form action={{url('update_property/' . $properties->id)}} method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @if (session('success'))
                                        ...
                                        <div class="row mb-3">
                                            {{-- <div class="col-md-6">
                                                ...
                                                <select name="property_type" id="property_type" class="form-select" required>
                                                    <option value="">{{$properties->property_type}}</option>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name = "propertysubType" id="propertysubType" value={{$properties->property_subtype}}>
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="propertyName" id="propertyName" value={{$properties->property_name}}>
                                            </div>
                                            <div class=" col-md-6">
                                                <label class="form-label" for="propertyPrice">Property Price</label>
                                                <input type="text" class="form-control" name="propertyPrice" id="PropertyPrice" value={{$properties->property_price}}>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="ownerName" id="ownerName" value={{$properties->property_owner}}>
                                            </div>
                                        </div>
                                        ...
                                        {{-- <div class="row mb-3">
                                            <div class="col-md-8">
                                                ...
                                                <input type="file" class="form-control" name="image" id="image" value={{$properties->image}}>
                                            </div>
                                        </div> --}}

                                        {{-- <div class="row mb-3">
                                            <div class=" col-md-6">
                                                <label class="form-label" for="propertyPrice">Description</label>
                                                <textarea class = "form-control" name="item_description" id="item_description" rows="3" value={{$properties->description}} required="required"></textarea>
                                            </div>
                                        </div> --}}
