                    ...
                    <div class="col-lg-12">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                <div class="card-body">
                                    <form action="{{url('update_property_type/' . $propertyTypes->id )}}" method="POST">
                                        @csrf
                                        @if (session('success'))
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="inputAddress">Property Type</label>
                                            <input type="text" class="form-control" name="property_type" id="property_type" value={{$propertyTypes->property_name}}>
                                        </div>
